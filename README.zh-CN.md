...
## 最新动态
- [2026/06] 🔥 RLinf 支持 [Genesis](https://github.com/Genesis-Embodied-AI/Genesis) 的强化学习微调。文档：[Genesis 强化学习训练](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/embodied/genesis.html)。
