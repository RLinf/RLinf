...
- [2026/09] 🔥 RLinf 支持在 LIBERO 上使用 Ray 管理的 FSDP 对 OpenWAM 进行全参数 SFT。文档：[OpenWAM SFT](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/embodied/sft_openwam.html)。
