...
## 最新动态
- [2026/04] 🔥 RLinf 现已支持基于 [GenieSim](https://github.com/AgibotTech/genie_sim)（Isaac Sim + MuJoCo）的人机协同 SAC 训练。文档：[基于 GenieSim 的强化学习](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/embodied/geniesim.html)。
    ...
    <tr>
      <td style="text-align: left; padding-left: 8px;">
        <ul style="margin-left: 0; padding-left: 16px;">
          ...
          <li><a href="https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/embodied/geniesim.html">GenieSim</a> ✅</li>
          <li>More...</li>
        </ul>
      </td>
      <td>
