...
- [2026/05] 🔥 RLinf 支持使用 Megatron-Bridge 后端进行 RL 训练与 SFT 微调。文档：[Megatron-Bridge](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/tutorials/advance/mbridge.html)。
