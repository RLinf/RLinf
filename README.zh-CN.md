...
## 最新动态
- [2026/07] 🔥 RLinf 集成 Diffusion-NFT，支持 SD3 和 Wan2.2 视频生成模型的强化学习。文档：[视频生成模型的强化学习](docs/source-zh/rst_source/examples/embodied/video_models.rst)。
    ...
    <tr>
      ...
      <td>
        <ul style="margin-left: 0; padding-left: 16px;">
          ...
          <li><b>视频生成模型的强化学习</b></li>
          <ul>
            <li><a href="docs/source-zh/rst_source/examples/embodied/video_models.rst">SD3 / Wan2.2</a> ✅</li>
          </ul>
          <li><b>自定义模型</b></li>
          <ul>
