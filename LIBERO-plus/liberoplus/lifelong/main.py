...
from liberoplus.lifelong.algos import get_algo_class, get_algo_list
from liberoplus.lifelong.models import get_policy_list
from liberoplus.lifelong.datasets import GroupedTaskDataset, SequenceVLDataset, get_dataset
from liberoplus.lifelong.metric import evaluate_loss, evaluate_success
...
def main(hydra_cfg):
    ...
    if cfg.use_wandb:
        wandb.init(project="liberoplus", config=cfg)
