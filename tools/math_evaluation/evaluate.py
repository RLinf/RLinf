...
def parse_args():
    ...
    parser.add_argument("--file_path", type=str, default='/mnt/public/xyq/Qwen2.5-Math/evaluation/outputs/mnt/public/xyq/ckpt/verl-7b-shuffle-scale_window-lr_cosine-16node_200/math_eval/aime24/test_r1-distilled-qwen_-1_seed0_t1.0_s0_e-1.jsonl')
