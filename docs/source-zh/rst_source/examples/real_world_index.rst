...
通过以下指南连接机械臂并运行硬件测试脚本。SO101 还提供 ``SO101ReachEnv-v1``、本地 OpenPI 评测和固定 checkpoint 的 gRPC 采集流程，可用于后续离线训练；Piper 目前提供硬件配置流程。
...
.. grid:: 1 2 2 2
   ...
   .. grid-item-card:: SO101
      ...
      配置电机、标定 SO-101，运行关节与夹爪测试脚本，并启动支持的评测流程。
