...
实验结果：
我们展示当前使用 Qwen2.5-VL-3B 模型的实验结果，当前实验在单台 8 x H100 Nvidia GPU 的机器上测试 6000 次迭代，实验结果如下：
...
我们展示当前使用 Qwen3-VL-4B 模型的实验结果，当前实验在单台 4 x H100 Nvidia GPU 的机器上测试 6000 次迭代，实验结果如下：
