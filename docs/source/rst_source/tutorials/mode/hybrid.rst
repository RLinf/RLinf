...
RLinf further augments the collocated mode and disaggregated mode, by introducing hybrid mode:
you can choose which tasks share the same set of GPUs and which tasks use separate GPUs.
