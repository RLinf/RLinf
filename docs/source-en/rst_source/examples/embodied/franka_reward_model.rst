...
:doc:`../../tutorials/embodied/reward_model_realworld`.
...
:doc:`../../tutorials/embodied/reward_model_realworld` for full configuration details.
...
See **Approach 2** in :doc:`../../tutorials/embodied/reward_model_realworld` for the full example.
...
see **Real-World Teleoperation with Live Reward Inference** in :doc:`../../tutorials/embodied/reward_model_realworld`.
