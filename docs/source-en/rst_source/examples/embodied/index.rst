    ...
    <div style="flex: 1 1 30%; max-width: 300px; text-align: center;">
     ...
     <div style="flex: 1 1 30%; max-width: 300px; text-align: center;">
       <img src="https://github.com/RLinf/misc/raw/main/pic/dagger.jpg"
            style="width: 100%; height: 200px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.15);" />
       <p style="margin-top: 8px; font-size: 14px; line-height: 1.4;">
         <a href="turtle2_dagger_takeover.html" style="text-decoration: underline; color: blue;">
           <b>Turtle2 Takeover Raw Data Collection</b>
         </a><br>
         Real-world raw episode collection with OpenPI rollout, master takeover, and the direct pose backend
       </p>
     </div>
