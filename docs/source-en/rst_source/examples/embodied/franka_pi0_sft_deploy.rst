Franka Real-World Pi0 SFT and Deployment End-to-End
====================================================
...
Here ``realworld_franka_pnp`` corresponds to the ``repo_id`` field in the
