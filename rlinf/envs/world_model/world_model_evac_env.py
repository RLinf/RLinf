...
from rlinf.models.world_model.evac.utils.general_utils import (
...
class EvacEnv(BaseWorldEnv):
    ...
    def _load_action_predictor(self):
        from rlinf.models.world_model.evac.action_model.action_predictor import (
            ActionPredictorMLP,
        )
    ...
    def _compute_delta_action(self, action_buffer):
        ...
        from rlinf.models.world_model.evac.sim.simulator import get_action_sim
    ...
    def add_new_frames(self, infos=None, rewards=None):
...
if __name__ == "__main__":
    ...
    def read_delta_actions(num_frames=80):
    ...
    delta_actions = delta_actions.reshape(10, chunk_steps, action_dim)
