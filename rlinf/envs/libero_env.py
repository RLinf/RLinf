...
class LiberoEnv(gym.Env):
    ...
    def get_env_fn_params(self, env_idx=None):
        ...
        for env_id in range(self.cfg.num_envs):
            ...
            env_fn_params.append({**base_env_args, "bddl_file_name": task_bddl_file, "seed": self.seed})
    ...
    def _get_task_and_trial_ids_from_reset_state_ids(self, reset_state_ids):
        ...
        print("get task and trial id", self.cumsum_trial_id_bins, reset_state_ids, task_ids, trial_ids)
    ...
    def step(self, actions = None, auto_reset=True):
        ...
        return obs, to_tensor(step_reward), to_tensor(terminations), to_tensor(truncations), infos
