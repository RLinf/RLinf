...
from rlinf.envs.diffusion.rewards import MultiRewardBackend
from rlinf.envs.diffusion.utils import (
    cfg_require,
    normalize_type,
)
...
def _build_single_reward_backend(cfg: Any) -> Any:
    ...
    module = import_module(f"rlinf.envs.diffusion.rewards.{reward_model}")
