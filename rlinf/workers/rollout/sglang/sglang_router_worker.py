...
class SGLangRouterWorker(Worker):
    ...
    def init_worker(self, **kwargs):
        ...
        logging_info = f"SGLangRouterWorker initialized with server addresses: {self._server_group.get_server_address().wait()}"
        print(logging_info)
        ...
        logging_info_2 = f"SGLangRouterWorker started router with base URL: {router_base_url} and worker URLs: {worker_urls}"
        print(logging_info_2)
