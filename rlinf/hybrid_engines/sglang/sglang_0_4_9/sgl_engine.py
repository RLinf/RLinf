...
class Engine(_Engine):
    def __init__(
        ...
        **kwargs,
        ...
        # Launch subprocesses
        tokenizer_manager, scheduler_info, template_manager = _launch_subprocesses(
...
def _launch_subprocesses(
...
) -> Tuple[TokenizerManager, Dict, TemplateManager]:
    """
    ...
    return tokenizer_manager, scheduler_info, template_manager
