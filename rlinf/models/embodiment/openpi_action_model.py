...
class OpenPi0ForRLActionPrediction(BasePolicy, PI0Pytorch):
    ...
    def set_state_norm_stats(
        self, state_norm_stats: Optional[dict[str, Any]], use_quantiles: bool = False
    ):
        """
    ...
    def obs_processor(self, env_obs):
        ...
        if "calvin" in self.config.config_name:
            ...
            if torch.is_tensor(state):
                ...
                # Convert numpy array to torch tensor (e.g., from normalize_openpi_state)
    ...
    def predict_action_batch(
        ...
        # torch.save(observation, "observation.pt")
