...
class LeRobotRealworldDataConfig(DataConfigFactory):
    """
    LeRobot data config for real-world Franka.
    Dataset columns: image, extra_view_image, state (19 → 7), actions (7), task (from meta).
    """
                ...
                _transforms.RepackTransform(
                    {
                        ...
                        "observation/extra_view_images": "extra_view_image",
