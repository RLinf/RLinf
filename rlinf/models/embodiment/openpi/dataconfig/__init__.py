...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        # Keep LIBERO's repo/asset id so RLinf-Pi05-LIBERO-SFT loads the exact
        # normalization statistics saved beside that checkpoint. This config is
        # intended for Turtle2 system bringup/profile, not a trained Turtle policy.
