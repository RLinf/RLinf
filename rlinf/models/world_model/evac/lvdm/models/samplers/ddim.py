...
from rlinf.models.world_model.evac.lvdm.common import extract_into_tensor, noise_like
from rlinf.models.world_model.evac.lvdm.models.utils_diffusion import (
        ...
        **kwargs,
        ...
        if conditioning is not None:
            if isinstance(conditioning, dict):
                first_key = list(conditioning.keys())[0]
                try:
                    cbs = conditioning[first_key].shape[0]
                except (AttributeError, IndexError, KeyError, TypeError):
                    cbs = conditioning[first_key][0].shape[0]
