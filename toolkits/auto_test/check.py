...
def check_global_step(log_file_path: str, threshold: Optional[float] = None, verbose: bool = True) -> Tuple[bool, bool]:
    """
    ...
    if threshold is None:
        threshold = total_steps * 0.1  # Dynamically calculate threshold as 10% of total steps
...
if __name__ == '__main__':
    ...
    parser.add_argument('--format', choices=['simple', 'verbose'], default='verbose',
