...
TASKS=(
    # Original tasks
    # 目前loading check point shard之后静默卡死
    # "maniskill_libero openvla-oft maniskill_ppo_openvlaoft 1 120 -1"
    # generating rollout epoch 静默卡死（GPU大部分时间利用率都很低，只有部分时间的GPU util有surge）
    ...
    # "maniskill_libero openpi maniskill_ppo_mlp 1 120 1"
    # vk::Device::waitForFences: ErrorDeviceLost RuntimeError: Unable to create GPU parallelized camera group. If the error is about being unable to create a buffer, you are likely using too many Cameras
