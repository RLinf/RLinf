...
#
# Supported configs:
#   yam_ppo_openpi           — 2 GPUs (actor + rollout on Beaker)
#   yam_ppo_openpi_topreward — 3 GPUs (actor + rollout + VLM planner on Beaker)
#
# Prerequisites:
...
ENTRYPOINT_CMD+=" && ip addr add \${TAILSCALE_NODE_IP}/32 dev lo || true"
