...
def main(cfg) -> None:
    ...
    if cfg.rollout.get('use_fixed_worker', False):
        ...
        assert (rollout_accel_num // 2) % cfg.rollout_fixed_worker.tensor_parallel_size == 0
        ...
        rollout_group = rollout_worker_cls.create_group(cfg, component_placement,  weight_reload=None).launch(
            cluster,
