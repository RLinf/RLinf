...
def main(cfg) -> None:
    ...
    if cfg.rollout.get('use_sub_worker', False):    
        ...
        rollout_accel_num = rollout_placement_strategy._end_hw_rank - rollout_placement_strategy._start_hw_rank + 1
        ...
        # planner_component_placement = copy.deepcopy(component_placement)
        # planner_component_placement._placement_mode = PlacementMode.DISAGGREGATED
