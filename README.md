...
- [2026/09] LingBot-VLA 2.0 supports RoboTwin PPO with full latent trajectory scoring. [Setup and validation](docs/source-en/rst_source/examples/embodied/lingbotvlav2.rst).
